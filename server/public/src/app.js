...
function bootstrap() {
    ...
    (0, app_data_source_1.dataSourceInit)();
    var app = express();
    ...
    app.get("/users/:id", function (req, res) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, app_data_source_1.myDataSource.getRepository(user_entity_1.User).findOneBy({ id: (_a = +req.params.id) !== null && _a !== void 0 ? _a : 1 })];
                    case 1:
                        user = _b.sent();
